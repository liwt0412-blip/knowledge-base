...
tags:
  ...
  - MartinFowler
status: 未提炼
title: 遗留系统迁移模式（Patterns of Legacy Displacement）
...
**来源**：https://martinfowler.com/articles/patterns-legacy-displacement/
**发布**：2024-03-05 ｜ **抓取**：2026-09-23

---

![](https://martinfowler.com/articles/patterns-legacy-displacement/tw-podcast.jpg)
...
|                                                                       |                                                                                  |
|-----------------------------------------------------------------------|----------------------------------------------------------------------------------|
| [Create Town Plan](create-town-plan.html)                             | Identify stable parts of the organisation to structure teams and software around |
| [Event Storming](event-storming.html)                                 | Technique used to understand business processes                                  |
| [Identify Business Capabilities](identify-business-capabilities.html) | Identify stable parts of the organisation to structure teams and software around |
| [Value Stream Map](value-stream-map.html)                             | Artefact that describes how users accomplish their work                          |
...
| [Extract Value Streams](extract-value-streams.html) | Identify and separate key value streams                                           |
...
|                                                             |                                                                                                                                     |
|-------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| [Canary Release](canary-release.html)                       | Roll out a change to a subset of users                                                                                              |
| [Critical Aggregator](critical-aggregator.html)             | Combine data from different parts of the business to support making critical decisions                                              |
| [Dark Launching](dark-launching.html)                       | Call a new back end feature without using results in order to assess its performance impact.                                        |
| [Divert the Flow](divert-the-flow.html)                     | First divert cross-organization activities away from legacy                                                                         |
| [Event Interception](event-interception.html)               | Intercept any updates to system state and route some of them to a new component                                                     |
| [Legacy Mimic](legacy-mimic.html)                           | New system interacts with legacy system in such a way that the old system is not aware of any changes.                              |
| [Revert to Source](revert-to-source.html)                   | Identify the originating source of data and integrate to that                                                                       |
| [Stop the World cutover](stop-the-world.html)               | Suspend normal business activities while cutting over to new system                                                                 |
| [Transitional Architecture](transitional-architecture.html) | Software elements installed to ease the displacement of a legacy system that we intend to remove when the displacement is complete. |
...
|                                                                     |                                                                                                |
|---------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| [Build as you mean to continue](build-as-you-mean-to-continue.html) | Create your legacy replacement in the way you need to continue once it is live.                |
| [Incremental Displacement](incremental-displacement.html)           | Create your legacy replacement in the way you need to continue once it is live.                |
| [New Co](new-co.html)                                               | Form a brand new company to pursue a market disruption                                         |
| [Protected Pilot](protected-pilot.html)                             | Create a pilot program for new work and detach it from the normal corporate governance process |
...
2.  Retire old system as soon as possible
...
2.  The vision for the Event Router was to enable, through configuration, routing of messages to an alternative destination - enabling the new implementation to process the publish messages. [Event Interception](https://www.martinfowler.com/bliki/EventInterception.html)
3.  The Event Router would also provide a bridge from the old SwiftMQ technology to the new ActiveMQ technology chosen for the target architecture.
