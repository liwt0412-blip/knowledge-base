...
<callout emoji="❗">
注意：自定义部署脚本提供的是基于intel芯片、Linux内核的docker镜像，如果是使用Mac的m1、m2芯片的同学，可能需要自己修改脚本中的镜像版本才行。
</callout>
...
![](03-环境部署实操/da98134b97c7.png)

设置内存为8G（有条件的同学选择16G）：

![](03-环境部署实操/954292c28596.png)

还有CPU核数，有条件的话尽可能调高：

![](03-环境部署实操/830b24d30d83.png)
...
![](03-环境部署实操/5b6306f40592.png)

查看/root目录的虚拟机内存文件：

![](03-环境部署实操/22f3010fbaea.png)
...
![](03-环境部署实操/044adc81dbf8.png)

再次通过`free -h`命令查看虚拟内存大小：

![](03-环境部署实操/dcb3b6960e4d.png)
...
<bookmark name="git.tianji.com" href="http://git.tianji.com"></bookmark>

![](03-环境部署实操/2e55b8e9c04d.png)
...
![](03-环境部署实操/8ba50fd96d9e.png)

然后进入仓库设置：

![](03-环境部署实操/b7c925daae37.png)

然后进入web钩子设置，可以看到现有的钩子访问的192.168.150.101这个地址：

![](03-环境部署实操/2e56d1b3101b.png)

点击修改，进入web钩子页面：

![](03-环境部署实操/37e580e504a3.png)
