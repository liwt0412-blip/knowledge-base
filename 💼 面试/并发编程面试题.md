...
![[多线程相关面试题.assets/image-20221026105350827.png]]
...
![[多线程相关面试题.assets/image-20221026105442158.png]]
...
![[多线程相关面试题.assets/image-20230503203246348.png]]



![[多线程相关面试题.assets/image-20221026105607248.png]]

多核CPU

每个核（core）都可以调度运行线程，这时候线程可以是并行的。

![[多线程相关面试题.assets/image-20230503203330700.png]]
...
![[多线程相关面试题.assets/image-20230503203629212.png]]
...
![[多线程相关面试题.assets/image-20230504165342501.png]]
...
![[多线程相关面试题.assets/image-20230504165833809.png]]
...
![[多线程相关面试题.assets/image-20230504172253826.png]]

我们需要重点分析MarkWord对象头

#### 2.2.2 MarkWord

![[多线程相关面试题.assets/image-20230504172541922.png]]
...
![[多线程相关面试题.assets/image-20230504172957271.png]]
...
![[多线程相关面试题.assets/image-20230504173520412.png]]

2.通过CAS指令将Lock Record的地址存储在对象头的mark word中（数据进行交换），如果对象处于无锁状态则修改成功，代表该线程获得了轻量级锁。

![[多线程相关面试题.assets/image-20230504173611219.png]]



3.如果是当前线程已经持有该锁了，代表这是一次锁重入。设置Lock Record第一部分为null，起到了一个重入计数器的作用。

![[多线程相关面试题.assets/image-20230504173922343.png]]
...
![[多线程相关面试题.assets/image-20230504173955680.png]]

3.如果Lock Record的 Mark Word不为null，则利用CAS指令将对象头的mark word恢复成为无锁状态。如果失败则膨胀为重量级锁。

![[多线程相关面试题.assets/image-20230504174045458.png]]
...
![[多线程相关面试题.assets/image-20230504174525256.png]]

2.通过CAS指令将Lock Record的**线程id**存储在对象头的mark word中，同时也设置偏向锁的标识为101，如果对象处于无锁状态则修改成功，代表该线程获得了偏向锁。

![[多线程相关面试题.assets/image-20230504174505031.png]]

3.如果是当前线程已经持有该锁了，代表这是一次锁重入。设置Lock Record第一部分为null，起到了一个重入计数器的作用。与轻量级锁不同的时，这里不会再次进行cas操作，只是判断对象头中的线程id是否是自己，因为缺少了cas操作，性能相对轻量级锁更好一些

![[多线程相关面试题.assets/image-20230504174736226.png]]
...
![[多线程相关面试题.assets/image-20230504181638237.png]]
...
![[多线程相关面试题.assets/image-20230504181947319.png]]
...
![[多线程相关面试题.assets/image-20230504182447552.png]]
...
![[多线程相关面试题.assets/image-20230505082441116.png]]
...
![[多线程相关面试题.assets/image-20230505082835588.png]]

屏障添加的示意图

![[多线程相关面试题.assets/image-20230505082923729.png]]
...
![[多线程相关面试题.assets/image-20230505083124159.png]]

屏障添加的示意图

![[多线程相关面试题.assets/image-20230505083217904.png]]
...
![[多线程相关面试题.assets/image-20230505083840046.png]]
...
![[多线程相关面试题.assets/image-20230505084451193.png]]
...
![[多线程相关面试题.assets/image-20230505091736569.png]]
...
![[多线程相关面试题.assets/image-20230505091827720.png]]
...
![[多线程相关面试题.assets/image-20230505092151244.png]]

而Sync的父类是AQS，所以可以得出ReentrantLock底层主要实现就是基于AQS来实现的

![[多线程相关面试题.assets/image-20230505091833629.png]]

**工作流程**

![[多线程相关面试题.assets/image-20230505092340431.png]]
...
![[多线程相关面试题.assets/image-20220902171032898.png]]
...
![[多线程相关面试题.assets/image-20220902171426738.png]]

第二：使用jstack查看线程运行的情况，下图是截图的关键信息

运行命令：`jstack -l 46032`

![[多线程相关面试题.assets/image-20220902172229567.png]]
...
![[多线程相关面试题.assets/image-20230505092654811.png]]
...
![[多线程相关面试题.assets/image-20230505093055382.png]]
...
![[多线程相关面试题.assets/image-20230505093507265.png]]
...
![[多线程相关面试题.assets/image-20230505205200628.png]]
...
![[多线程相关面试题.assets/image-20230505210853493.png]]
...
![[多线程相关面试题.assets/image-20230505211002252.png]]
...
![[多线程相关面试题.assets/image-20230505211209336.png]]
...
![[多线程相关面试题.assets/image-20230505220514872.png]]
...
![[多线程相关面试题.assets/image-20230505220701835.png]]
...
![[多线程相关面试题.assets/image-20230505221424359.png]]
...
![[多线程相关面试题.assets/image-20230505221837189.png]]
...
1. 创建使用固定线程数的线程池
   ...
   ![[多线程相关面试题.assets/image-20230505221959259.png]]
...
2. 单线程化的线程池，它只会用唯一的工作线程来执行任 务，保证所有任务按照指定顺序(FIFO)执行
   ...
   ![[多线程相关面试题.assets/image-20230505222050294.png]]
...
3. 可缓存线程池
   ...
   ![[多线程相关面试题.assets/image-20230505222126391.png]]
...
4. 提供了“延迟”和“周期执行”功能的ThreadPoolExecutor。
   ...
   ![[多线程相关面试题.assets/image-20230505222203615.png]]
...
![[多线程相关面试题.assets/image-20220821003816845.png]]
...
![[多线程相关面试题.assets/image-20230505223014946.png]]
...
![[多线程相关面试题.assets/image-20230505223219951.png]]

详细实现流程：

![[多线程相关面试题.assets/image-20230505223246059.png]]
...
![[多线程相关面试题.assets/image-20230505223442924.png]]
...
- 报表汇总
  ...
  ![[多线程相关面试题.assets/image-20230505223536657.png]]



#### 4.1.4 案例二（异步调用）

![[多线程相关面试题.assets/image-20230505223640038.png]]
...
![[多线程相关面试题.assets/image-20230505224057228.png]]
...
![[多线程相关面试题.assets/image-20230505224341410.png]]
...
![[多线程相关面试题.assets/image-20230505224626253.png]]

**get方法/remove方法**

![[多线程相关面试题.assets/image-20230505224715087.png]]
...
![[多线程相关面试题.assets/image-20230505224755797.png]]

- 弱引用：表示一个对象处于可能有用且非必须的状态。在GC线程扫描内存区域时，一旦发现弱引用，就会回收到弱引用相关联的对象。对于弱引用的回收，无关内存区域是否足够，一旦发现则会被回收

![[多线程相关面试题.assets/image-20230505224812015.png]]

每一个Thread维护一个ThreadLocalMap，在ThreadLocalMap中的Entry对象继承了WeakReference。其中key为使用弱引用的ThreadLocal实例，value为线程变量的副本

![[多线程相关面试题.assets/image-20230505224857538.png]]
...
![[image-20230505223533130.png]]
![[image-20230505222319526.png]]
![[image-20230505083159269.png]]
![[image-20230504173711041.png]]
![[image-20230504173414009.png]]
![[image-20230504172414210.png]]
![[image-20221026111506307.png]]
![[image-20221026111313057.png]]
![[image-20221026111246089.png]]
![[image-20221026111227136.png]]
![[image-20221026111154135.png]]
![[image-20221026110452264.png]]
![[image-20221026110310947.png]]
![[image-20221026105641323.png]]
![[image-20221007151919542.png]]
![[image-20221007151910345.png]]
![[image-20220902224028438.png]]
![[image-20220902223846871.png]]
![[image-20220902222715863.png]]
![[image-20220902222630304.png]]
![[image-20220902135259000.png]]
![[image-20220901184120726.png]]
![[image-20220901183856096.png]]
![[image-20220901140857623.png]]
![[image-20220901123045003.png]]
![[image-20220901123003719.png]]
![[image-20220901123.png]]
![[image-20220901121822268.png]]
![[image-20220901121814290.png]]
![[image-20220901112811374.png]]
![[image-20220901110122451.png]]
![[image-20220831195353786.png]]
![[image-20220819133305480.png]]
![[image-20220819132839511.png]]
![[image-20220205094926130.png]]
![[image-20220205094004602.png]]
![[image-20220205092454233.png]]
![[image-20220204222010008.png]]
![[image-20210831093204388.png]]
![[image-20210824164853535.png]]
![[image-20210824164717055.png]]
![[image-20221026111429301.png]]
