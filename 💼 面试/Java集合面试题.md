...
![[Java集合相关面试题.assets/image-20230427173120668.png]]

#### 1.2.3 常见复杂度表示形式

![[Java集合相关面试题.assets/image-20230427173742389.png]]
...
![[Java集合相关面试题.assets/image-20230427173937663.png]]
...
![[Java集合相关面试题.assets/image-20230427174832858.png]]
...
![[Java集合相关面试题.assets/image-20230427175545402.png]]

我们定义了这么一个数组之后，在内存的表示是这样的：

![[Java集合相关面试题.assets/image-20230427175633253.png]]

现在假如，我们通过`arrar[1]`，想要获得下标为1这个元素，但是现在栈内存中指向的堆内存数组的首地址，它是如何获取下标为1这个数据的？

![[Java集合相关面试题.assets/image-20230427175849493.png]]

#### 2.1.2 寻址公式

为了方便大家理解，我们把数组的内存地址稍微改了一下，都改成了数字，如下图

![[Java集合相关面试题.assets/image-20230427180056509.png]]
...
![[Java集合相关面试题.assets/image-20221007101831281.png]]

情况二：查找排序后数组内的元素，通过二分查找算法查找55号数据时间复杂度为O(logn)

![[Java集合相关面试题.assets/image-20221007101811885.png]]
...
![[Java集合相关面试题.assets/image-20220820104903422.png]]

新增之后的数据变化，如下

![[Java集合相关面试题.assets/image-20220820104950846.png]]
...
![[Java集合相关面试题.assets/image-20230427192118259.png]]
...
![[Java集合相关面试题.assets/image-20230427192154014.png]]

>- 第一个构造是带初始化容量的构造函数，可以按照指定的容量初始化数组
>
>- 第二个是无参构造函数，默认创建一个空集合

![[Java集合相关面试题.assets/image-20230427192200918.png]]
...
![[Java集合相关面试题.assets/image-20230427192644244.png]]
...
![[Java集合相关面试题.assets/image-20230428185505677.png]]
...
![[Java集合相关面试题.assets/image-20230428185600918.png]]
...
![[Java集合相关面试题.assets/image-20230428185657791.png]]
...
![[Java集合相关面试题.assets/image-20230428185922776.png]]

代码实现参考：

![[Java集合相关面试题.assets/image-20230428185945929.png]]
...
![[Java集合相关面试题.assets/image-20230428190130901.png]]
...
![[Java集合相关面试题.assets/image-20230428190210915.png]]
...
![[Java集合相关面试题.assets/image-20230428190324752.png]]

![[Java集合相关面试题.assets/image-20230428190353286.png]]
...
![[Java集合相关面试题.assets/image-20230428190450517.png]]
...
![[Java集合相关面试题.assets/image-20230428194715016.png]]
...
![[Java集合相关面试题.assets/image-20230428194831426.png]]

Java中有两个方式实现二叉树：数组存储，链式存储。

基于链式存储的树的节点可定义如下：

![[Java集合相关面试题.assets/image-20230428194904383.png]]

![[Java集合相关面试题.assets/image-20230428194931132.png]]
...
![[Java集合相关面试题.assets/image-20230428195206422.png]]

（2）二叉搜索树-时间复杂度分析

实际上由于二叉查找树的形态各异，时间复杂度也不尽相同，我画了几棵树我们来看一下插入，查找，删除的时间复杂度

![[Java集合相关面试题.assets/image-20230428195341917.png]]
...
![[Java集合相关面试题.assets/image-20230428195449799.png]]
...
![[Java集合相关面试题.assets/image-20230428195832724.png]]
...
![[Java集合相关面试题.assets/image-20230428200919454.png]]
...
![[Java集合相关面试题.assets/image-20230428201000814.png]]
...
![[Java集合相关面试题.assets/image-20230428201321607.png]]
...
![[Java集合相关面试题.assets/image-20230428203219225.png]]

#### 3.2.3 散列冲突-链表法（拉链）

在散列表中，数组的每个下标位置我们可以称之为桶（bucket）或者槽（slot），每个桶(槽)会对应一条链表，所有散列值相同的元素我们都放到相同槽位对应的链表中。

![[Java集合相关面试题.assets/image-20230428203437910.png]]
...
![[Java集合相关面试题.assets/image-20230428203711269.png]]
...
![[Java集合相关面试题.assets/image-20230428203858903.png]]

- 将链表法中的链表改造为其他高效的动态数据结构，比如红黑树，查询的时间复杂度是 O(logn)

![[Java集合相关面试题.assets/image-20230428203924816.png]]
...
![[Java集合相关面试题.assets/image-20230428204902016.png]]
...
![[Java集合相关面试题.assets/image-20230428210404117.png]]

#### 3.4.2 源码分析

![[Java集合相关面试题.assets/image-20230428210450744.png]]
...
![[Java集合相关面试题.assets/image-20230428210624847.png]]
...
![[Java集合相关面试题.assets/image-20230428210844694.png]]

扩容的流程：

![[Java集合相关面试题.assets/image-20230428211031968.png]]
...
![[Java集合相关面试题.assets/image-20230428213115071.png]]
...
![[Java集合相关面试题.assets/image-20230428213533483.png]]

线程2扩容后，由于头插法，链表顺序颠倒，但是线程1的临时变量e和next还引用了这两个节点

![[Java集合相关面试题.assets/image-20230428214732877.png]]

第一次循环

由于线程2迁移的时候，已经把B的next执行了A

![[Java集合相关面试题.assets/image-20230428214806072.png]]

第二次循环

![[Java集合相关面试题.assets/image-20230428214908652.png]]

第三次循环

![[Java集合相关面试题.assets/image-20230428214937231.png]]
...
![[Java集合相关面试题.assets/image-20221007110404375.png]]
