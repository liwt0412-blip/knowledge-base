<title>day05-[[day04-MQ基础|MQ]]高级</title>

> 📂 [[微服务框架-黑马新版|课程索引]]
> 📝 [[day05-MQ高级面试问答]] — 10道面试题
> 🔥 [[day05-MQ面试练习-逐句修正]] — Hermes四轮拷问实录

对应的B站视频：

<readonly-block href="https://player.bilibili.com/player.html?bvid=1S142197x7&amp;amp;p=101&amp;amp;vd_source=1ff0c1b434581723cf696ccc2f59ceaa" type="iframe"></readonly-block>





在昨天的练习作业中，我们改造了余额支付功能，在支付成功后利用[[day04-MQ基础|RabbitMQ]]通知交易服务，更新业务订单状态为已支付。
...
<whiteboard token="VvwxwNNShhQ9Ptbn2EDcC5YZnNe"></whiteboard>
...
![](images_day05-MQ高级/89ad28880da6.png)
...
![](images_day05-MQ高级/4a0a377ff599.png)
...
![](images_day05-MQ高级/33ac4c49d121.png)
...
![](images_day05-MQ高级/f7a9333d6e4d.png)
...
![](images_day05-MQ高级/cbace5a4a83d.png)
...
![](images_day05-MQ高级/9c74b41381ae.png)
...
![](images_day05-MQ高级/36954ce18db4.png)
...
![](images_day05-MQ高级/5e3ab0361336.png)
...
![](images_day05-MQ高级/b49d73a311b9.png)
...
![](images_day05-MQ高级/6803108dec58.png)
...
![](images_day05-MQ高级/183ab690d740.png)
...
![](images_day05-MQ高级/a73a7f65e84c.png)

放行以后，由于抛出的是**消息转换异常**，因此Spring会自动返回`reject`，所以消息依然会被删除：

![](images_day05-MQ高级/9e5723333315.png)
...
![](images_day05-MQ高级/f2dd5d46431f.png)

放行以后，由于抛出的是业务异常，所以Spring返回`ack`，最终消息恢复至`Ready`状态，并且没有被RabbitMQ删除：

![](images_day05-MQ高级/2c0ee36a4286.png)
...
![](images_day05-MQ高级/e98ad52cf658.png)
...
<whiteboard token="HZXww1NF9hNWzlbIlQecYemBn2U"></whiteboard>
...
![](images_day05-MQ高级/1db3e4765a83.png)



假如我们现在发送一条消息到`ttl.fanout`，RoutingKey为blue，并设置消息的**有效期**为5000毫秒：

![](images_day05-MQ高级/7f29b33e8da4.png)
...
![](images_day05-MQ高级/0f0f7b25efa1.png)

死信被再次投递到死信交换机`hmall.direct`，并沿用之前的RoutingKey，也就是`blue`：

![](images_day05-MQ高级/ba7fa70345ef.png)
...
![](images_day05-MQ高级/6955bc2d7570.png)
...
<bookmark name="Scheduling Messages with RabbitMQ | RabbitMQ - Blog" href="https://blog.rabbitmq.com/posts/2015/04/scheduling-messages-with-rabbitmq"></bookmark>
...
<bookmark name="GitHub - rabbitmq/rabbitmq-delayed-message-exchange: Delayed Messaging for RabbitMQ" href="https://github.com/rabbitmq/rabbitmq-delayed-message-exchange"></bookmark>

由于我们安装的MQ是`3.8`版本，因此这里下载`3.8.17`版本：

![](images_day05-MQ高级/7cf18293e238.png)

当然，也可以直接使用课前资料提供好的插件：

![](images_day05-MQ高级/ad990a51b88f.png)
...
![](images_day05-MQ高级/0955f6f2564e.png)
...
![](images_day05-MQ高级/20a560126d3b.png)
...
![](images_day05-MQ高级/2b14a01815b0.png)
...
![](images_day05-MQ高级/483eb0022f3b.png)
...
![](images_day05-MQ高级/508da4d568ff.png)
...
![](images_day05-MQ高级/37d4b3b9e4a8.png)
